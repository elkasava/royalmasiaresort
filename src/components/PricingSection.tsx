    ...
    <section id="tarieven" className="section-padding bg-[#f5ede4]">
      <div className="container-wide">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {/* Main rate */}
          <div className="md:col-span-2 bg-[#1a3a22] p-10 text-white relative overflow-hidden" data-reveal>
            ...
            <div className="flex items-end gap-3 mb-6">
              <p
                style={{ fontFamily: "var(--font-cormorant)", fontStyle: "italic", fontWeight: 300, fontSize: "5rem", lineHeight: 1 }}
          ...
          <div className="space-y-4" data-reveal data-delay="0.15">
            ...
            <div className="bg-white border border-[#dfc0b0] p-8">
              ...
              <h3
                style={{ fontFamily: "var(--font-cormorant)", fontStyle: "italic", fontWeight: 300, fontSize: "1.6rem" }}
                className="text-[#1a3a22] mb-3"
              >
                Keuken huur
              </h3>
              <p
                style={{ fontFamily: "var(--font-cormorant)", fontStyle: "italic", fontWeight: 300, fontSize: "2.5rem" }}
            ...
            <div className="bg-[#0e1e12] p-8 text-white">
              <p
                style={{ fontFamily: "var(--font-cormorant)", fontStyle: "italic", fontWeight: 300, fontSize: "1.3rem" }}
                className="text-[#b83428] mb-3"
              >
                Reserveren?
              </p>
              <p
